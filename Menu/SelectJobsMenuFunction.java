...
public class SelectJobsMenuFunction implements IGenericAction
{
	private StatsGui gui;

	public SelectJobsMenuFunction(StatsGui gui)
	{
		this.gui = gui;
	}
	...
	public void Invoke()
	{
		...
		for(int i = 0; i < this.gui.partyMembers.size(); i++)
		{
			...
			buttons.add(new GenericScrollBoxCellData(partyMember.CombatEntity.name, "", new ShowJobsForCharMenuFunction(this.gui, partyMember, "")));
		}
		...
		this.gui.ChangeButtonForSubMenu("SelectMemberForJobs", buttons, constantButtons, 1);
	}
}
